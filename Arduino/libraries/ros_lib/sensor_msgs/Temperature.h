#ifndef ros_sensor_msgs_Temperature_h
#define ros_sensor_msgs_Temperature_h
...
namespace sensor_msgs
{
  ...
  class Temperature : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer)
    {
      ...
      long * val_temperature = (long *) &(this->temperature);
      long exp_temperature = (((*val_temperature)>>23)&255);
      if(exp_temperature != 0)
        exp_temperature += 1023-127;
      long sig_temperature = *val_temperature;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      unsigned long * val_temperature = (unsigned long*) &(this->temperature);
      offset += 3;
      *val_temperature = ((unsigned long)(*(inbuffer + offset++))>>5 & 0x07);
      *val_temperature |= ((unsigned long)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_temperature |= ((unsigned long)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_temperature |= ((unsigned long)(*(inbuffer + offset)) & 0x0f)<<19;
      unsigned long exp_temperature = ((unsigned long)(*(inbuffer + offset++))&0xf0)>>4;
      exp_temperature |= ((unsigned long)(*(inbuffer + offset)) & 0x7f)<<4;
      if(exp_temperature !=0)
